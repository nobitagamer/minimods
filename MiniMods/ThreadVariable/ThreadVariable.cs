...
namespace Minimod.ThreadVariable
{
    ...
    public class ThreadVariable<T>
    {
        ...
        /// </summary>
        private readonly bool fallbackDefined = false;
        ...
        /// </summary>
        [ThreadStatic]
        private static Dictionary<ThreadVariable<T>, ThreadVariableValueScope> values;
        ...
        /// <summary>
        /// Returns <see cref="values"/> and creates a new dictionary if it doesn't exist.
        /// </summary>
        private static Dictionary<ThreadVariable<T>, ThreadVariableValueScope> EnsuredValues
        {
            ...
            {
                if (values == null)
                    values = new Dictionary<ThreadVariable<T>, ThreadVariableValueScope>(1);
                return values;
            }
        }
        ...
        {
            get { return fallbackDefined || EnsuredValues.ContainsKey(this); }
        }
        ...
        {
            private readonly ThreadVariable<T> key;
